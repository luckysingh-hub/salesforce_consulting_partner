        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-2 mb-3">
                <div class="services-project">
                  ...
                  <div class="serv-po-head">Omnistudio</div>
            ...
            <div class="col-lg-4 col-md-6 mb-2 mb-3">
                <div class="services-project">
                  ...
                  <div class="serv-po-head">API Integration</div>
            ...
            <div class="col-lg-4 col-md-6 mb-2 mb-3">
                <div class="services-project">
                  ...
                  <div class="serv-po-head">Salesforce Implementation</div>
            ...
            <div class="col-lg-4 col-md-6 mb-2 mb-3">
                <div class="services-project">
                  ...
                  <div class="serv-po-head">Support And Maintenance</div>
