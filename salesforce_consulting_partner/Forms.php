    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-lg-4 mx-auto mb-3">
                <img src="../client//imageFoleder//icon-1-1-1.svg" alt="form icon">
            ...
            <div class="col-lg-4 mx-auto mb-3">
                <img src="../client//imageFoleder//icon-2-1-1.svg" alt="form icon">
            ...
            <div class="col-lg-4 mx-auto mb-3">
                <img src="../client//imageFoleder//icon-4-2.svg" alt="form icon">
